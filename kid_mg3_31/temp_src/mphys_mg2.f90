...
!NOTE (AG 3/2017: these should probably be nz+1!)
  ...
  real(r8) :: lflxo(nx,nz)       ! grid-box average liquid condensate flux (kg m^-2 s^-1)
  real(r8) :: iflxo(nx,nz)       ! grid-box average ice condensate flux (kg m^-2 s^-1)
...
!other (for output)
  ...
  real(r8) ::flip_rflxo(nx,nz) 
  real(r8) ::flip_sflxo(nx,nz) 
  real(r8) ::flip_iflxo(nx,nz) 
  real(r8) ::flip_lflxo(nx,nz) 
...
!NEW
       ...
       rflxo(:,:)=flip_rflxo(:,nz:1:-1)
       sflxo(:,:)=flip_sflxo(:,nz:1:-1)
       iflxo(:,:)=flip_iflxo(:,nz:1:-1)
       lflxo(:,:)=flip_lflxo(:,nz:1:-1)

...
!       i=1
!       print*,'AUTO k,pgam,qcic,ncic,qric,rho,relvar,prc',k,pgam(i,k),qcic(i,k),ncic(i,k),qric(i,k),rho(i,k),relvar(i,k),prc(i,k)
     endif	  
...
!       i=1
!       print*,'ACCR k,qcic,ncic,qric,rho,relvar,pra',k,qcic(i,k),ncic(i,k),qric(i,k),rho(i,k),relvar(i,k),pra(i,k)
...
!        print*,'k,qctend,lcldm,pra,prc,mnuccc,mnucct,msacwi,psacws,berg,bergs:',k,qctend(i,k),lcldm(i,k),pra(i,k),prc(i,k) 
!        print*,'k,qctend,mnuccc,mnucct,msacwi,psacws,berg,bergs:',k,qctend(i,k),mnuccc(i,k),mnucct(i,k),msacwi(i,k),psacws(i,k),berg(i,k),bergs(i,k)

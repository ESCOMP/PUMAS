!++KID
!module micro_mg3_0
module module_mp_mg3

#define HAVE_GAMMA_INTRINSICS

!FOR KiD, based on micro_mg3.F90
! https://svn-ccsm-models.cgd.ucar.edu/cam1/branch_tags/mg3_tags/mg3_31_cam5_4_153/  
! Differences from CAM code marked between !++KID and !--KID
!--KID
...
!++KID
pure subroutine micro_mg3_get_cols(ncol, nlev, top_lev, qcn, qin, &
!--KID
!++ag
...
!++KID
end subroutine micro_mg3_get_cols
!--KID

!++KID
!end module micro_mg3_0
end module module_mp_mg3
!--KID

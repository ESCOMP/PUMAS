!++ag
!module micro_mg1_5
module module_mp_mg1_5
 
#define HAVE_GAMMA_INTRINSIC
 
!FOR KiD, based on micro_mg1_5.F90 from 
!https://svn-ccsm-models.cgd.ucar.edu/cam1/trunk_tags/cam5_3_51/models/atm/cam/src/physics/cam/micro_mg2_0.F90
!Differences from CAM code marked between !++ag and !--ag
